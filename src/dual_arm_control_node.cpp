...
int main(int argc, char** argv) {
  ...
  if (isSimulation) {
    topic_pose_object = "/simo_track/object_pose";
  } else {
    topic_pose_object = "/simo_track/object_pose0";
    // topic_pose_object = "/simo_track/object_pose1";
  }
  ...
  std::cout << "TOPIC " << topic_sub_ForceTorque_Sensor[0] << std::endl;
